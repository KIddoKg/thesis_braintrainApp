...
List<TileModel> duplicatedImage = [];

String correctImg = "assets/correct.png";
...
// !List Check Border IMG (ảnh nào có border)
List<int> border = [];
Color selectedImageBorderColor = Colors.transparent;

// ! Chứa vị trí các ảnh đã chọn đúng
