...
int score = 0; // ! Điểm mỗi lượt
int bonus = 0;
// ! Điểm tổng
int total = 0;
// int level = 1;
int tries = 1; // Lượt chơi 3

// ! Số hình đúng của mỗi lượt
int numOfCard = 0;
int numOfCard_1 = 0;
int numOfCard_2 = 0;
...
// var listOfList = [getAnimal(), getPairs_2(), getPairs_3(), getPairs_4()];
