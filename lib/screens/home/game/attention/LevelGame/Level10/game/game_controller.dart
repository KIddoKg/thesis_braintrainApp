      ...
      case GameControl.WEAPON_BUILDING:
        ...
        if (component != null) {
          ...
          component.blockMap = component.collision(controller.rc01) ||
              ...
              component.collision(controller.rc15) ||
              ...
              component.collision(controller.rc24) ||
              component.collision(controller.rc25) ||
              component.collision(controller.rc26) ||
              ...
              component.collision(controller.rc34) ||
              component.collision(controller.rc35) ||
              component.collision(controller.rc36) ||
              ...
              component.collision(controller.rc45) ||
              ...
              component.collision(controller.rc62) ||
              ...
              component.collision(controller.rc67) ||
              component.collision(controller.rc68) ||
              component.collision(controller.rc69) ||
              // component.collision(controller.rc70) ||
              component.collision(controller.rc71) ||
              component.collision(controller.rc72) ||
              component.collision(controller.rc73) ||
              component.collision(controller.rc74) ||
              component.collision(controller.rc75) ||
              component.collision(controller.rc76) ||
              component.collision(controller.rc77) ||
              component.collision(controller.rc78) ||
              // component.collision(controller.rc79) ||
              component.collision(controller.rc80) ||
              component.collision(controller.rc81) ||
              component.collision(controller.rc82) ||
              component.collision(controller.rc83) ||
              component.collision(controller.rc84) ||
              // component.collision(controller.rc85) ||
              component.collision(controller.rc86) ||
              component.collision(controller.rc87) ||
              component.collision(controller.rc88) ||
              component.collision(controller.rc89) ||
              component.collision(controller.rc90) ||
              component.collision(controller.rc91) ||
              // component.collision(controller.rc92) ||
              ...
              component.collision(controller.rc97) ||
              component.collision(controller.rc98) ||
              component.collision(controller.rc99) ||
              component.collision(controller.gateStart) ||
              component.collision(controller.gateStart2) ||
              component.collision(controller.gateStart3) ||
              component.collision(controller.gateStart4);
...
class GameController extends GameComponent {
  ...
  late NeutualComponent gateStart3;
  late NeutualComponent gateStart4;
  late NeutualComponent gateEnd;
  late NeutualComponent gateEnd2;
  late NeutualComponent gateEnd3;
  late NeutualComponent gateEnd4;
  late NeutualComponent gateEnd5;
  late NeutualComponent gateEnd6;
  late NeutualComponent gateEnd7;
  late NeutualComponent gateEnd8;
  ...
  void loadGate() async {
    ...
    //   add(gateEnd);
    // }
    Vector2 test, start, end, start2,start3, start4, end2, end3, end4, end5, end6, end7, end8;
    Vector2 rcv01,
        rcv02,
        rcv03,
        rcv04,
    ...
    end8 = Vector2(9, 2);
    end2 = Vector2(7, 9);
    start3 = gameSetting.dotMultiple(start3, gameSetting.mapTileSize) +
        (gameSetting.mapTileSize / 2);
    start4 = gameSetting.dotMultiple(start4, gameSetting.mapTileSize) +
        (gameSetting.mapTileSize / 2);
    start = gameSetting.dotMultiple(start, gameSetting.mapTileSize) +
        (gameSetting.mapTileSize / 2);
    end = gameSetting.dotMultiple(end, gameSetting.mapTileSize) +
    ...
    end3 = gameSetting.dotMultiple(end3, gameSetting.mapTileSize) +
        (gameSetting.mapTileSize / 2);
    end4 = gameSetting.dotMultiple(end4, gameSetting.mapTileSize) +
        (gameSetting.mapTileSize / 2);
    end5 = gameSetting.dotMultiple(end5, gameSetting.mapTileSize) +
        (gameSetting.mapTileSize / 2);
    end7 = gameSetting.dotMultiple(end7, gameSetting.mapTileSize) +
        (gameSetting.mapTileSize / 2);
    end8 = gameSetting.dotMultiple(end8, gameSetting.mapTileSize) +
        (gameSetting.mapTileSize / 2);
    end6 = gameSetting.dotMultiple(end6, gameSetting.mapTileSize) +
        (gameSetting.mapTileSize / 2);
    ...
    gateStart2 = NeutualComponent(
        ...
        size: gameSetting.mapTileSize,
        neutualType: NeutualType.GATE_START);
    gateStart3 = NeutualComponent(
        position: start3,
        size: gameSetting.mapTileSize,
        neutualType: NeutualType.GATE_START);
    gateStart4 = NeutualComponent(
        position: start4,
        size: gameSetting.mapTileSize,
        neutualType: NeutualType.GATE_START);
    gateEnd = NeutualComponent(
    ...
    gateEnd3 = NeutualComponent(
        ...
        neutualType: NeutualType.GATE_END)
      ..sprite = Sprite(await Flame.images.load('whitehole.png'));
    gateEnd4 = NeutualComponent(
        position: end4,
        size: gameSetting.mapTileSize,
        neutualType: NeutualType.GATE_END)
      ..sprite = Sprite(await Flame.images.load('whitehole.png'));
    gateEnd5 = NeutualComponent(
        position: end5,
        size: gameSetting.mapTileSize,
        neutualType: NeutualType.GATE_END)
      ..sprite = Sprite(await Flame.images.load('whitehole.png'));
    gateEnd6 = NeutualComponent(
        position: end6,
        size: gameSetting.mapTileSize,
        neutualType: NeutualType.GATE_END)
      ..sprite = Sprite(await Flame.images.load('whitehole.png'));
    gateEnd7 = NeutualComponent(
        position: end7,
        size: gameSetting.mapTileSize,
        neutualType: NeutualType.GATE_END)
      ..sprite = Sprite(await Flame.images.load('whitehole.png'));
    gateEnd8 = NeutualComponent(
        position: end8,
        size: gameSetting.mapTileSize,
        neutualType: NeutualType.GATE_END)
      ..sprite = Sprite(await Flame.images.load('whitehole.png'));
