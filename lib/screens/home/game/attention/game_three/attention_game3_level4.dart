...
import '../../../../../viewModel/data/data_onborad/data_attention_3.dart';
import '../../../../../shared/light_colors.dart';
import '../Attention_Screen.dart';
import '../LevelGame/Level4/game/game_main.dart';
import '../LevelGame/Level4/game/game_test.dart';

class GameAtte3Level4 extends StatefulWidget {
  const GameAtte3Level4({Key? key}) : super(key: key);

  @override
  State<GameAtte3Level4> createState() => _GameAtte3Level4State();
}

class _GameAtte3Level4State extends State<GameAtte3Level4> {
  ...
  sendData(int killedEnemy, int heathResult, String status,
      {int? level}) async {
  ...
  final List<ExplanationData> data = [
    ExplanationData(
        ...
        localImageSrc:
            "https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExOTU5OWVlMDljNWQzODE2YjViZGY4YjMwOWQ1MzZmNDZmNzk2MjcxYSZlcD12MV9pbnRlcm5hbF9naWZzX2dpZklkJmN0PWc/UPF0adMulZIJUxZK8w/giphy.gif",
    ...
    ExplanationData(
        ...
        title: "Trò chơi Bắt cá",
        localImageSrc:
            "https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExNjc4ZGUxZjNiNGE2NmMwOGIxYmIwYTQ2YmM3ODJkY2UzNjhjZmNlZSZlcD12MV9pbnRlcm5hbF9naWZzX2dpZklkJmN0PWc/HK2oPQC7Da0JYSSMkj/giphy.gif",
        backgroundColor: AppColors.primaryColor),
  ];
    ...
    return FutureBuilder<SharedPreferences>(
      ...
      builder:
        ...
        if (snapshot.hasData) {
          ...
          int checkLevel = snapshot.data!.getInt('AttePass') ?? 0;
          if (checkLevel < 5) {
            textUnclock = "Cấp độ 5 đã được mở khóa";
          } else {
            textUnclock = "Quay lại màn hình chính";
          }
          if (killedEnemy != null) {
            sendData(killedEnemy, heathResult, "success", level: 4);
            return WillPopScope(
                onWillPop: () async {
    ...
    return FutureBuilder<SharedPreferences>(
      ...
      builder:
        ...
        if (snapshot.hasData) {
          ...
          int? heathResult = snapshot.data!.getInt('heath_Result')!;
          if (killedEnemy != null) {
            sendData(killedEnemy, heathResult, "fail");
            return WillPopScope(
              onWillPop: () async {
                Navigator.pushReplacement(
                    context,
