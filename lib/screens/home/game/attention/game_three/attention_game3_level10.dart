...
import '../LevelGame/Level10/game/game_main.dart';
import '../LevelGame/Level10/game/game_test.dart';
...
class GameAtte3Level10 extends StatefulWidget {
  const GameAtte3Level10({Key? key}) : super(key: key);

  @override
  State<GameAtte3Level10> createState() => _GameAtte3Level10State();
}

class _GameAtte3Level10State extends State<GameAtte3Level10> {
    ...
    return FutureBuilder<SharedPreferences>(
      ...
      builder: (BuildContext context, AsyncSnapshot<SharedPreferences> snapshot) {
        if (snapshot.hasData) {
          ...
          if (killedEnemy != null) {
            sendData(killedEnemy,heathResult,"true", level: 10);
            return WillPopScope(
                onWillPop: () async {
                  Navigator.pushReplacement( context,
                      MaterialPageRoute(builder: (context) => const AttentionScreen()));
